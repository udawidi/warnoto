...
5. **Cek App.jsx belum ditest.** Kalau commit ini menyentuh `App.jsx`, ingatkan user untuk pastikan sudah `npm run build` sukses dan (idealnya) sudah dicoba di browser — jangan asumsikan otomatis aman, ini sudah beberapa kali jadi sumber bug menurut `docs/CLAUDE_HANDOFF.md` section 5.
