...
- Operasional self-host: deploy atau perbaikan Edge Function dilakukan melalui `ssh minipc-gudang` pada volume `/home/admin_warnoto/vps-dr-stack/volumes/functions/`, bukan Supabase Cloud atau Supabase CLI.
